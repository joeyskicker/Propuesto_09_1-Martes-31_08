...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		...
		int uni = leerUnidades();
		double pre = leerPrecio();
		Factura nuevo = new Factura(ruc, empresa, uni, pre);
		af.adicionar(nuevo);
		listar();
		limpieza();
	}
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		txtS.setText("");
		imprimir("Cantidad de facturas :  " + af.tamanio());
		imprimir("Importe promedio facturado: " + af.promedioImportes());
		imprimir("Suma de todos los importes :  " + af.sumaImportes());
		imprimir("Menor importe facturado :  " + af.importeMenor());
		imprimir("Mayor importe facturado :  " + af.importeMayor());
		imprimir("Primera empresa con importe menor al promedio :  " + af.primeraEmpresaImpMenor());
  	}
	...
	void limpieza() {
   	...
   	void listar() {
		...
		for (int i=0; i<af.tamanio(); i++) {
			Object[] fila = { af.obtener(i).getRuc(),
							  af.obtener(i).getEmpresa(),
							  af.obtener(i).getUnidades(),
							  af.obtener(i).getPrecio(),
							  af.obtener(i).importeFacturado() };
			modelo.addRow(fila);
		}
	}
